...
Câu 7 (Nâng cao). Vấn đề Triệt tiêu Đạo hàm (Vanishing Gradient)

Việc sử dụng hàm kích hoạt Sigmoid ở các tầng ẩn sâu trong Mạng Neural nhiều tầng (Deep Neural Network) có thể dẫn đến hiện tượng Vanishing Gradient. Giải thích cơ chế toán học đằng sau hiện tượng này.
