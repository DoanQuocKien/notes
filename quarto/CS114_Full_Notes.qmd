...
Với dữ liệu email có ba thuộc tính nhị phân như `free`, `win`, `meeting`, cách làm luôn giống nhau.
...
$$P(\text{free=Yes}\mid \text{Spam}),\quad
P(\text{win=Yes}\mid \text{Spam}),\quad
P(\text{meeting=No}\mid \text{Spam})$$
...
P(\text{free=Yes}\mid\text{Spam})
P(\text{win=Yes}\mid\text{Spam})
P(\text{meeting=No}\mid\text{Spam})$$

$$score(\text{Not Spam})=P(\text{Not Spam})
P(\text{free=Yes}\mid\text{Not Spam})
P(\text{win=Yes}\mid\text{Not Spam})
P(\text{meeting=No}\mid\text{Not Spam})$$
...
Khi bảng có nhiều cột như `Outlook`, `Temperature`, `Humidity`, `Wind`, hãy tính từng thuộc tính theo cùng một khung.
...
$$z_{h_1}=0.1(1)+0.2(2)+0.1=0.6,\quad h_1=\sigma(0.6)\approx0.6457$$

$$z_{h_2}=0.3(1)+0.4(2)+0.1=1.2,\quad h_2=\sigma(1.2)\approx0.7685$$

Forward output:

$$z_o=0.5(0.6457)+0.6(0.7685)+0.1\approx0.8840$$

$$\hat{y}=\sigma(0.8840)\approx0.7076$$

Loss:

$$L=\frac12(0.7076-1)^2\approx0.04275$$

Output error:

$$\delta_o=\frac{\partial L}{\partial z_o}
=(\hat{y}-y)\hat{y}(1-\hat{y})
=(0.7076-1)(0.7076)(0.2924)\approx-0.06050$$

Gradient tầng output:

$$\frac{\partial L}{\partial w_{h_1\to o}}=\delta_o h_1=(-0.06050)(0.6457)\approx-0.03907$$

$$\frac{\partial L}{\partial w_{h_2\to o}}=\delta_o h_2=(-0.06050)(0.7685)\approx-0.04650$$

$$\frac{\partial L}{\partial b_o}=\delta_o\approx-0.06050$$

Hidden error:

$$\delta_{h_1}=\delta_o w_{h_1\to o}h_1(1-h_1)
=(-0.06050)(0.5)(0.6457)(0.3543)\approx-0.00692$$

$$\delta_{h_2}=\delta_o w_{h_2\to o}h_2(1-h_2)
=(-0.06050)(0.6)(0.7685)(0.2315)\approx-0.00646$$

Gradient tầng ẩn:

$$\frac{\partial L}{\partial w_{x_1\to h_1}}=\delta_{h_1}x_1=-0.00692,\quad
\frac{\partial L}{\partial w_{x_2\to h_1}}=\delta_{h_1}x_2=-0.01384$$

$$\frac{\partial L}{\partial w_{x_1\to h_2}}=\delta_{h_2}x_1=-0.00646,\quad
\frac{\partial L}{\partial w_{x_2\to h_2}}=\delta_{h_2}x_2=-0.01292$$
...
| Tham số | Giá trị mới |
| :--- | :--- |
| $w_{x_1\to h_1}$ | $0.1-0.1(-0.00692)=0.10069$ |
| $w_{x_2\to h_1}$ | $0.2-0.1(-0.01384)=0.20138$ |
| $w_{x_1\to h_2}$ | $0.3-0.1(-0.00646)=0.30065$ |
| $w_{x_2\to h_2}$ | $0.4-0.1(-0.01292)=0.40129$ |
| $w_{h_1\to o}$ | $0.5-0.1(-0.03907)=0.50391$ |
| $w_{h_2\to o}$ | $0.6-0.1(-0.04650)=0.60465$ |
| $b_{h_1}$ | $0.1-0.1(-0.00692)=0.10069$ |
| $b_{h_2}$ | $0.1-0.1(-0.00646)=0.10065$ |
| $b_o$ | $0.1-0.1(-0.06050)=0.10605$ |

**Cách tự kiểm tra dấu.** Vì $y=1$ nhưng $\hat{y}=0.7076$ còn thấp, $\delta_o<0$. Khi cập nhật $w\leftarrow w-\eta dW$, các gradient âm làm nhiều trọng số tăng lên, giúp lần dự đoán sau có xu hướng đẩy $\hat{y}$ cao hơn.
