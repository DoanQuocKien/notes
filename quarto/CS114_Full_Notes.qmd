...
\phi_{j \mid y=1}
=
\frac{\sum_{i=1}^{n} \mathbb{I}(x_j^{(i)} = 1 \land y^{(i)} = 1)}
...
\phi_{j \mid y=0}
=
\frac{\sum_{i=1}^{n} \mathbb{I}(x_j^{(i)} = 1 \land y^{(i)} = 0)}
...
\phi_{j \mid y=1}
=
\frac{\sum_{i=1}^{n} \mathbb{I}(x_j^{(i)} = 1 \land y^{(i)} = 1) + 1}
{\sum_{i=1}^{n} \mathbb{I}(y^{(i)} = 1) + 2}
$$
